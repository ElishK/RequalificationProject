...
# _________________________________________________________ technical treatement of situation, when user input different number than the number of provided choices of commands are
...
# _________________________________________________________ while cycle controling the length of the password
...
# _________________________________________________________ if condition requires other than empy item input

        if len(item) == 0:
            print("Empty search query. Please enter some information.")
            continue

# _________________________________________________________ command cursor.execute is sending cursor to database named users as a reaction to input information to fetch input information throught user_name or email or dog_name column and print the user or users containing input information
